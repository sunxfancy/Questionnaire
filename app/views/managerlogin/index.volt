 ...
 <table>
     <tr style="height:100px;"><td style="width:500px;font-size:40px;color:purple;">欢 迎 登 录</td></tr>
            ...
            <table>
                ...
                <tr>
                    <td style="width: 100px; font-family: 'Microsoft YaHei' ">密码</td><td><input onfocus="getfocus(this);" onblur="getblur(this);" type="text" dir="ltr" id="password" name="password" style="font-size:20px; height: 36px;line-height: 36px;outline: none;font-size: 20px;width: 180px;border: 1px solid #C7C7C7;background: #F3F3F3;border-radius: 2px;padding: 0 5px;font-family:'Microsoft YaHei';color:silver;"  value="初始密码为123456">
                    </td>
                </tr>
            </table>
                   ...
                   <td style="width:100%;text-align:center;">
                     <div onmousedown="    this.style.backgroundColor = '#e56419'" onmouseup="    this.style.backgroundColor = '#d49a3e'" style="width:100%;height:40px;background-color:#d49a3e;font-family:'Microsoft YaHei';font-size:21px;text-align:center;cursor:pointer;"  >
                         <table style="width:100%;height:100%" cellspacing="0">
                            <tr style="width:100%;height:100%;">
                                  <td style="width:100%;height:100%;vertical-align:middle"><input type='submit' value='登录'/></td>
                             </tr>
                        </table>
                     </div>
                 </td>
