...
class WordExport
{
	...
	public function allReport($project_id){
		...
		$section->addText("北京XXX集团",array('size'=>36, 'color'=>'red','bold'=>true),array('align'=>'center'));
		$section->addTextBreak(1);
		$section->addText("中青年人才综合测评总体分析报告",array('size'=>36, 'color'=>'red','bold'=>true),array('align'=>'center'));
		$section->addPageBreak();

		$section->addText("北京XXX集团",array('size'=>24, 'color'=>'red','bold'=>true),array('align'=>'center'));
		$section->addText("中青年人才综合测评总体分析报告",array('size'=>24, 'color'=>'red','bold'=>true),array('align'=>'center'));
		...
		$section->addText("为了充分开发中青年人才资源，了解中青年人才水平、培养有潜力人才及科技骨干、选拔一批经验丰富，德才兼备的中青年高技能人才，北京XXX集团（后简称“集团”），采用第三方北京技术交流培训中心(以下简称“中心”)自主研发26年，通过上下、左右、前后六维（简称“6＋1”）测评技术，对集团".$project->last_examinee_id."名中青年人才进行了一次有针对性的测评。分别于".$project->begintime."到".$project->endtime."，在集团培训中心进行上机测试。规定测评时间为3小时，最短完成时间为".$min_time."，一般为".$avg_time."左右。 ");
		...
		$section->addText("通过对".$project->last_examinee_id."位中青年人才综合统计分析，按优良中差排序结果为：全体优秀率达".$level1."，良好".$level2."。在测评和专家面询后，对全部人才进行了无记名的满意度调查，参加调查83人，回收有效问卷83份，有效率100%，满意度100%。（满意度调查报告详见附件1） ");
